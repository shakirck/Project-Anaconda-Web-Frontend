...
"venomous":[{
                    ...
                    
    {
        ...
        "malayalam" : "ചുരുട്ട ",
        "url":"http://13.126.210.153/u/611c0845-32b4-43fe-9454-73a6c7955872.jpg",
        "distribution":"Found only in the western ghats",
        "description":`A Nocturnal and terrestrial pitviper, found in evergreen to dry deciduous forest and plantations in the region. Head is flat, triangular and broader than neck with a hump on the tip of snout. eyes have vertical pupil. Heat sensing pit present between eyes and nostril.s Sides of head usually dark brown in color, edged above with a whitish line ; sometimes a white, black-edged, longitudinal streak on each side of the neck. Scales are smooth or weakly keeled.Body color varying from pale grey to reddish brown with black specks, patches or spots on the body.
        Prefer moist and leaf littered ground or found under rocks, logs with its head angled slightly upwards. Excellently camouflaged and stay motionless on the ground as an ambush predator. Feeds on small rodents, lizards, geckos and frogs.
        Bites need medical attention` ,
        "states":" Karnataka, Kerala, Tamil Nadu, Goa, Maharashtra", 
    },

    {
        ...
        "description":     `New born- 43-50cm., average- 300cm (10ft)., maximum- 585cm (19.19ft). Individuals above 480cm (16ft) are not common in India.

        Head large with rounded snout, covered with large shields and slightly broader than neck. Large eyes bear rounded pupil.Body very long, slender and covered with large smooth scales. Dorsal color variable according to geography which includes grey, black, dark olive green, yellow-brown with yellow or white bands throughout the body. Population of far north-east have almost patternless appearance of bluish-black. Population of Andaman Islands is rusty-brown with or without bands. Bands of hood region are inverted V shaped and known for having characteristic to differentiate individuals. Ventral color usually pale yellow or grayish with dark shades on edge of many ventral scales. Underside of hood bears extensions of dorsal coloration which is characteristic to recognize different individuals.`     ,
        "states": 'Andhra Pradesh, Arunachal Pradesh, Assam, Chhattisgarh, Goa, Karnataka, Kerala, Manipur, Meghalaya, Mizoram, Nagaland, Odisha, Sikkim, Tamil Nadu, Tripura, Uttarakhand, West Bengal, Andaman and Nicobar, '
    ...
    
    {
        ...
        Body slender with smooth oval shaped scales. Dorsal color geographically variable from yellow, all shades of brown, dark gray, reddish, black or black mixed with blue, purple, red etc. Side dorsal scales larger and clearly oval shaped while scales on the top narrower and become pointed. Maharashtra, whole South India, Andhra Pradesh, Odisha, West Bengal etc. coastal states populations lighter while central-northern population dark brown or black. Ventral color ranges from milky white, yellowish, white mixed with purple, red, brown, gray etc with or without dark patches.`      ,
        "description":   `Head triangular with rounded edge, not broader than neck. The famous hood mark appears when stretched on provocation. In dark color adult specimens from North India hood mark becomes faint or absent in adults. Eyes have rounded pupil.

        Body slender with smooth oval shaped scales. Dorsal color geographically variable from yellow, all shades of brown, dark gray, reddish, black or black mixed with blue, purple, red etc. Side dorsal scales larger and clearly oval shaped while scales on the top narrower and become pointed. Maharashtra, whole South India, Andhra Pradesh, Odisha, West Bengal etc. coastal states populations lighter while central-northern population dark brown or black. Ventral color ranges from milky white, yellowish, white mixed with purple, red, brown, gray etc with or without dark patches.`       ,
        "states" :"Goa, Gujarat, Haryana, Jharkhand, Karnataka, Kerala, Madhya Pradesh, Maharashtra, Odisha, Punjab, Rajasthan, Tamil Nadu, Telangana, Uttar Pradesh, Uttarakhand, Chandigarh, Dadra and Nagar Haveli, Daman and Diu, Delhi, Puducherry, "
...
"nonVenomous":[
...

   {
    ...
    "url":"http://13.126.210.153/u/aa9b792e-039b-45b4-9038-b129fdb55d9d.jpg",
    "distribution": "Found in south of Palghat Gap of Kerala and Tamil Nadu. Type locality: South Travancore Hills, Kerala"     ,
    "description":  `Can grow upto 51cm.
    ...
    {
    "name":      "striped keelback "           ,
    "malayalam":        "തെയ്യം പാമ്പ് "    ,
    "url":"http://13.126.210.153/u/1b4a9392-f219-43a8-afe2-2111c6899d2b.jpg",
